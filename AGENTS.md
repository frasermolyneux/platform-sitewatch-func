# AGENTS.md — platform-sitewatch-func

Repository `platform-sitewatch-func` in the frasermolyneux organization. Adapt this brief with repo-specific scope and validation commands.
